...
function Main() {
    ...
    return (
        ...
        <div className="note">
            ...
            non-automated transactional and marketing calls/texts from Wag!. Consent not required: text STOP to 24006 to apt out. Opy out instructions subject to change. Message and data rates may apply. Mobile Terms apply.  
        </div>
        <div className="checkbox-group">
            <input type="checkbox" id="terms"></input>
            <label for="terms">I agree to Wag's Terms and Privacy Policy.</label>
        </div>
        <div className="checkbox-group">
